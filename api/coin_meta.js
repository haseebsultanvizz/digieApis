		...
		Promise.all([
			...
			Promise.all([
				...
				for (let i = 0; i < main_bid_json_arr.length; i = i + offset_value) {
					...
					db.collection('chart3_group').updateOne(where_json, {$set: data_to_insert}, {"upsert": true}, function(err22, obj22){
                        if (err22) throw err22;
                        //console.log(obj22.result)
                    });
                ...
                Promise.all([ 
                    ...
                    // FOR GET TOP PERCENT FUNCTION
                    topPerArr['five_min_buy_sell'] = parseFloat(get_rolling_five_mins_trade_vol_response_json_resolved['sellers_buyers_per']);
                    //
                    ...
                    // FOR GET TOP PERCENT FUNCTION
                    topPerArr['last_qty_buy_sell'] = get_contract_one_response_json_resolved['last_qty_buy_vs_sell'];
                    //
                    chart3_response['last_qty_time_ago'] = get_contract_one_response_json_resolved['time_string'];
                    // FOR GET TOP PERCENT FUNCTION
                    topPerArr['last_qty_time_ago'] = get_contract_one_response_json_resolved['time_string'];
                    //
                    ...
                    // FOR GET TOP PERCENT FUNCTION
                    topPerArr['last_qty_time_ago_15'] = get_contracts_three_response_json_resolved['time_string'];
                    //
                    ...
                    // FOR GET TOP PERCENT FUNCTION
                    topPerArr['fif_min_buy_sell'] = get_rolling_fifteen_mins_trade_vol_response_json_resolved['sellers_buyers_per_fifteen'];
                    //
                    ...
                    //update coin meta
                    console.log(chart3_response);
                    delete chart3_response._id;
                    db.collection("coin_meta").updateOne({"coin": "XRPBTC"}, {$set: chart3_response}, {"upsert": true}, async function(err33, obj){
                        if (err33) throw err33;
                        console.log(obj.result, "===> coin_meta update");
                    });
